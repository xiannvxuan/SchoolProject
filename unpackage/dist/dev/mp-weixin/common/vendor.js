...
/***/ 130:
/*!**************************************************************************!*\
  !*** /Users/wayxuan/Desktop/SchoolProject/components/uni-icons/icons.js ***!
  \**************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 25:
/*!***********************************************************!*\
  !*** /Users/wayxuan/Desktop/SchoolProject/request/api.js ***!
  \***********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _request = _interopRequireDefault(__webpack_require__(/*! ./request.js */ 26));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
//								-----全局-----
//图片上传
api.uploadImg = function (params) {return _request.default.globalRequest('/upload/image', 'POST', params);};
//获取学校列表
api.getSchoolList = function (params) {return _request.default.globalRequest('/get_schools', 'POST', params);};
//获取评论列表
api.getComment = function (params) {return _request.default.globalRequest('/get/comment', 'GET', params);};
//点赞
api.digg = function (params) {return _request.default.globalRequest('/digg', 'POST', params);};
//发布评论
api.createMessage = function (params) {return _request.default.globalRequest('/create/message', 'POST', params);};


// 								-----首页-----
//获取当前课程表
api.getCurrentCourse = function (params) {return _request.default.globalRequest('/get_course/current', 'GET', params);};
//获取第week周的课程表
api.getWeekCourse = function (params) {return _request.default.globalRequest('/get_course/by_week', 'GET', params);};
//获取tag标签
api.getTag = function (params) {return _request.default.globalRequest('/get_tag', 'GET', params);};
...
api.createMessage = function (params) {return _request.default.globalRequest('/create/message', 'POST', params);};
//获取全部动态
api.getSelfMessage = function (params) {return _request.default.globalRequest('/get/self_message', 'GET', params);};
//获取全部动态
api.getMessage = function (params) {return _request.default.globalRequest('/get/message', 'GET', params);};
//获取热门动态
api.getHotMessage = function (params) {return _request.default.globalRequest('/get/hot_message', 'GET', params);};
//获取自己动态
api.getUserMessage = function (params) {return _request.default.globalRequest('/get/user_message', 'GET', params);};


// 								 -----寄卖-----
//创建二手商品
api.createSecondHand = function (params) {return _request.default.globalRequest('/create/second_hand', 'POST', params);};
//获取自己的二手商品
api.getSelfSecondHand = function (params) {return _request.default.globalRequest('/get/self_second_hand', 'GET', params);};var _default =
...
/***/ 26:
/*!***************************************************************!*\
  !*** /Users/wayxuan/Desktop/SchoolProject/request/request.js ***!
  \***************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _config = _interopRequireDefault(__webpack_require__(/*! ./config.js */ 27));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
request.globalRequest = function (url, method, data, dataType) {
...
/***/ 27:
/*!**************************************************************!*\
  !*** /Users/wayxuan/Desktop/SchoolProject/request/config.js ***!
  \**************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 34:
/*!****************************************************!*\
  !*** /Users/wayxuan/Desktop/SchoolProject/Json.js ***!
  \****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.scheduleList = exports.entrustDetail = exports.reviewList = exports.orderList = exports.productList = exports.wtList = exports.dynamicDetail = exports.dynamicList = exports.courseListTwo = exports.courseList = exports.swipperList = exports.goodsList = exports.shareList = exports.userInfo = exports.lazyLoadList = exports.detailData = exports.carouselList = void 0;var _ref, _dynamicDetail;function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;} // 首页轮播图
var swipperList = [{
...
// 首页课程表
exports.swipperList = swipperList;var courseList = {
  "status_code": 0,
  "message": "success",
  "alert_message": "",
  "school_name": "北京大学",
...
//课程列表
exports.courseList = courseList;var courseListTwo = {
  "status_code": 0,
  "message": "success",
  "alert_message": "",
  "school_name": "北京大学",
...
//动态列表
exports.courseListTwo = courseListTwo;var dynamicList = { "status_code": 0,
  "message": "success",
  "message_infos": [(_ref = {
    ...
    "school": "北京大学",
    "sex": "男",
    "good1": "23" }, _defineProperty(_ref, "good1",
  "232"), _defineProperty(_ref,
  "avator", "https://cmyk-so.com/source/image/origin/00000000003d.png"), _defineProperty(_ref,
  "urls", [
  ...
  "https://cmyk-so.com/source/image/origin/00000000003f.png"]), _defineProperty(_ref,
  "create_time", 1592133236), _ref),
...
//动态详情
exports.dynamicList = dynamicList;var dynamicDetail = (_dynamicDetail = {
  "message_id": 17,
  "content": "",
  "nickname": "手里的老干妈突然不香了",
  "school": "北京大学",
  "sex": "男",
  "good1": "23" }, _defineProperty(_dynamicDetail, "good1",
"232"), _defineProperty(_dynamicDetail,

"avator", "https://cmyk-so.com/source/image/origin/00000000003d.png"), _defineProperty(_dynamicDetail,
"urls", [
"https://cmyk-so.com/source/image/origin/00000000003c.png",
"https://cmyk-so.com/source/image/origin/00000000003d.png",
"https://cmyk-so.com/source/image/origin/00000000003e.png",
"https://cmyk-so.com/source/image/origin/00000000003f.png"]), _defineProperty(_dynamicDetail,
"create_time", "2020-07-10"), _defineProperty(_dynamicDetail, "content",
"这里是商品描述描述啊这里是商品描述描述啊这里是商品描述描述啊这里是商品描述描述啊这里是商品描述描述啊这里是商品描述描述啊"), _dynamicDetail);

//委托列表
exports.dynamicDetail = dynamicDetail;var wtList = [
{
  url: '../../../static/img/mine.jpeg',
  user_name: '小火柴',
  sex: 1,
...
//委托详情
exports.wtList = wtList;var entrustDetail = {
  nick_name: '小火柴',
  creat_time: '2019-09-10',
  content: '区域快线上使命，需要声扽这个木在诸多互动的。区域快线上使命，需要声扽这个木在诸多互动的区域快线上使命，需要声扽这个木在诸多互动的区域快线上使命，需要声扽这个木在诸多互动的',
  user_name: '王五',
...
//评价列表
exports.entrustDetail = entrustDetail;var reviewList = [{
  url: '../../../static/img/mine.jpeg',
  user_name: '小火柴',
  sex: 1,
  creat_time: '2019-09-10',
...
//课程列表
exports.reviewList = reviewList;var scheduleList = {
  status_code: 0,
  courses: [
  {
    week_num: 1,
...
//寄卖/二手商品列表
exports.scheduleList = scheduleList;var productList = [];
/* 用户 */exports.productList = productList;
var userInfo = {
  status: 1,
  data: {
    id: 1,
...
/* 首页轮播图 */exports.userInfo = userInfo;
var carouselList = [{
...
/* 商品列表 */exports.carouselList = carouselList;
var goodsList = [{
...
//详情展示页面
exports.goodsList = goodsList;var detailData = {
  title: '纯种金毛幼犬活体有血统证书',
  title2: '拆家小能手 你值得拥有',
  favorite: true,
  imgList: [{
...

  {
    ...
    time: '09-20 12:54',
    zan: '54',
    content: '楼上说的好有道理。' }] };exports.detailData = detailData;
...

{
  ...
  text: 'QQ空间' }];exports.shareList = shareList;
...
{
  src: 'http://pic1.win4000.com/mobile/3/57888a298d61d.jpg' }];exports.lazyLoadList = lazyLoadList;
...

{
  ...
  {
    image: 'https://gd3.alicdn.com/imgextra/i3/819381730/O1CN01YV4mXj1OeNhQIhQlh_!!819381730.jpg_400x400.jpg' }] }];exports.orderList = orderList;

/***/ }),

/***/ 4:
/*!*******************************************************!*\
  !*** /Users/wayxuan/Desktop/SchoolProject/pages.json ***!
  \*******************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ 43:
/*!**********************************************************!*\
  !*** /Users/wayxuan/Desktop/SchoolProject/utils/date.js ***!
  \**********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
